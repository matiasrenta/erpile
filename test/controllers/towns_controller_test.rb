...
class TownsControllerTest < ActionController::TestCase
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post :create, town: { abbreviation: @town.abbreviation, name: @town.name, state_id: @town.state_id }
    end
  ...
  test "should update town" do
    patch :update, id: @town, town: { abbreviation: @town.abbreviation, name: @town.name, state_id: @town.state_id }
    assert_redirected_to town_path(assigns(:town))
  end
