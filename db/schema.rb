...
ActiveRecord::Schema.define(version: 20200922232453) do
  ...
  create_table "expense_attaches", force: :cascade do |t|
  ...
  create_table "project_attaches", force: :cascade do |t|
    t.integer  "project_id"
    t.string   "file_id"
    t.string   "file_filename"
    t.integer  "file_size"
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.datetime "created_at",                                     null: false
    t.datetime "updated_at",                                     null: false
    t.date     "fecha_inicio_estimada"
    t.integer  "duracion_estimada"
    t.decimal  "porcentaje_avance",     precision: 3,  scale: 2
  end
